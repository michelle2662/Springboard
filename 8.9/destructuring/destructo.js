...
const [firstElement, , , , , sixth] = stones
console.log(`First: ${firstElement}, Sixth: ${sixth}`)
...
const [firstShadow, ...restShadows] = shadows
console.log(`Visible: ${firstShadow}, Hidden: ${restShadows}`)
...
revealPath({direction: "left", distance: "100"})
...
function castSpell([ingredient1, ingredient2]){
	console.log(`Using ${ingredient1} and ${ingredient2}`)
}
